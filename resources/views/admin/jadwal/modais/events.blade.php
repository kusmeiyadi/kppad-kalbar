    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Tambah Kegiatan</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formEvent">
                    ...
                    <div class="form-group row">
                        <label for="start" class="col-sm-4 col-form-label">Tanggal/Waktu mulai</label>
                        <div class="col-sm-8">
                            <input type="text" name="start" class="form-control date-time" id="start">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="end" class="col-sm-4 col-form-label">Tanggal/Waktu selesai</label>
                        <div class="col-sm-8">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger deleteEvent">Hapus</button>
                <button type="button" class="btn btn-primary saveEvent">Simpan</button>
            </div>
        </div>
    </div>
</div>