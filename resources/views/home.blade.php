        ...
        <div class="w-60 w-md-100 float-left float-md-none h-100 h-md-40 h-xs-50">
            ...
            <div class="w-50 w-xs-100 float-left float-xs-none pos-relative h-100 h-xs-50">
                ...
                <div class="abs-blr color-white p-20">
                    <h3 class="mb-10 mb-sm-5 t-upper">
                        <a class="hover-grey" href="#"><b>WHAT'S INCLUDED IN CONGRESS' $13 TRILLION SPENDING
                                BILL</b></a>
                    </h3>
            ...
            <div class="w-50 w-xs-100 float-left float-xs-none pos-relative h-100 h-xs-50 pt-xs-10">
                <div class="mlr-10 mr-md-0 ml-xs-0 pos-relative h-100">
                    ...
                    <div class="abs-blr color-white p-20">
                        <h3 class="mb-10 mb-sm-5 t-upper">
                            <a class="hover-grey" href="#"><b>Five places under the falls and above the clouds</b></a>
                        </h3>
                        <ul class="list-li-mr-10 color-grey">
                            <li><i class="mr-5 font-12 ion-clock"></i>Jan 25, 2018</li>
                            <li><i class="mr-5 font-12 ion-android-person"></i>John Dowson</li>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="mb-30 mt-md-30 p-30 card-view">
                    ...
                    <ul
                        class="font-12 text-center color-white list-block list-a-block list-a-ptb-10 list-li-mb-10 list-a-br-5 list-a-hvr-primary">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <a class="hover-grey dplay-block" href="#">
                    ...
                    <h5 class="mt-15"><b>Dan carter rolls back years while pro dominance leaves England</b></h5>
                </a>
            ...
            <div class="col-sm-6 col-md-3">
                <a class="hover-grey dplay-block" href="#">
                    ...
                    <h5 class="mt-15"><b>Josua VS Parker: Worldcup winners and a mascat</b></h5>
                </a>
                <ul class="mt-5 mb-30 list-li-mr-20 color-lite-black">
                    <li><i class="mr-5 font-12 ion-clock"></i>Jan 25, 2018</li>
                    <li><i class="mr-5 font-12 ion-eye"></i>105</li>
            ...
            <div class="col-sm-6 col-md-3">
                <a class="hover-grey dplay-block" href="#">
                    ...
                    <h5 class="mt-15"><b>Srilanka has a secret lake local aren't tell you absout</b></h5>
                </a>
                <ul class="mt-5 mb-30 list-li-mr-20 color-lite-black">
                    <li><i class="mr-5 font-12 ion-clock"></i>Jan 25, 2018</li>
                    <li><i class="mr-5 font-12 ion-eye"></i>105</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h4 class="mt-30"><a href="#">
                                    <b>Look beyond the revived Tiger Smitchel for a Homegrown Master champion</b></a>
                            </h4>
                            <ul class="mtb-10 list-li-mr-5 color-lite-black">
                                <li><i class="mr-5 font-12 ion-clock"></i>Jan 25, 2018</li>
                                <li><i class="mr-5 font-12 ion-android-person"></i>John Dowson</li>
            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="mt-30 p-30 plr-40 card-view text-center">
                    ...
                    <form class="form-sm max-w-400x mlr-auto">
                        ...
                        <h6><button class="mt-15 plr-20 btn-b-sm btn-fill-primary dplay-block"
                                type="submit"><b>SUBSCRIBE NOW</b></button></h6>
                    </form>
                </div><!-- card-view -->
