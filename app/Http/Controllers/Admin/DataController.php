...
class DataController extends Controller
{
  ...
  public function index(){
      $datas = Pengaduan::orderBy('created_at', 'DESC')->get();
      $jenis_kasus = JenisKasus::all();
      $totals = Pengaduan::select('jenis_kasus_id', DB::raw("(DATE_FORMAT(created_at, '%Y')) as year"))
      ...
      return view('admin.data.backup', compact('totals','jenis_kasus','datas'));
  }
}
